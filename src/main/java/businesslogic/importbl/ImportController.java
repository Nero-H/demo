...
public class ImportController extends UnicastRemoteObject implements ImportBLService{
	...
	public boolean updateImportReturn(String receiptsID, boolean isPass)
		...
		// TODO Auto-generated method stub
		return import1.updateImportReturn(receiptsID, isPass);
	}


	public boolean updateStart(String receiptsID) throws RemoteException {
		// TODO Auto-generated method stub
		return import1.updateStart(receiptsID);
	}
	...
	public boolean updateImport(String receiptsID, boolean isPass)
			throws RemoteException {
		// TODO Auto-generated method stub
		return import1.updateImport(receiptsID, isPass);
	}
