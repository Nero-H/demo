...
public interface SalesInterface {
	...
	public void transform_SalesPOs_to_SalesVOs(ArrayList<SalesFatherPO> pos,ArrayList<SalesVO> vos); //转换
	public void transform_SalesPO_to_SalesVO(SalesFatherPO po, SalesVO vo);
}
